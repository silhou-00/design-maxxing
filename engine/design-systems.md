...
Cold reference. Load only when `engine.md` §3 routes the brief to a real design system.
Extracted verbatim from `taste/.agents/skills/design-taste-frontend/SKILL.md` (Appendices A-C).
