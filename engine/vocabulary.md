...
Cold reference. Names for patterns, so they can be discussed and reached for deliberately.
Not a library and not a mandate — a pack's `## banned` list still governs.
Extracted verbatim from `taste/.agents/skills/design-taste-frontend/SKILL.md` (Section 10).
